            ...
            <div className='divActive'>
                <ul className='header-content-1'>
                    <div className='up'>
                        ...
                        <div className='scroll-bar-1'>
                            <div className="scroll-bar-1-el-down" onClick={() => setToggle2(!toggle2)}>
                                <div className="scroll-bar-1-el-down-div">
                                    <svg className="svg-icon-1" viewBox="0 0 20 20">
                                    ...
                                    <div className="scroll-bar-1-el-down-div-text">
                                        <p>Formlar</p>
                                    </div>
                                </div>
                                <div className="scroll-bar-1-el-down-svg">
                                    <svg className="svg-icon-two-1" viewBox="0 0 20 20">
                                        <path fill="none"
                          ...
                          9.624,13.388,9.624z M10,1.344c-4.781,0-8.656,3.875-8.656,8.656c0,4.781,3.875,8.656,8.656,8.656c4.781,0,8.656-3.875,8.656-8.656C18.656,5.219,14.781,1.344,10,1.344z M10,17.903c-4.365,0-7.904-3.538-7.904-7.903S5.635,2.096,10,2.096S17.903,5.635,17.903,10S14.365,17.903,10,17.903z"
                            ...
                            {!toggle2 && (
                                <div className="scroll-bar-1-dropdown">
                                    <div className="scroll-bar-1-dropdown-el">
                                        <Link to="/contact">
                                            <div className="scroll-bar-1-dropdown-el-p">
                                                <p>Əlaqə</p>
                                            </div>
                                        </Link>
                        ...
                        <div className='scroll-bar-1'>
                            <div
                                className="scroll-bar-1-el-down"
