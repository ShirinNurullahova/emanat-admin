...
const InternShipAbout = () => {
    ...
    const onSubmitHandler = async (values) => {
        ...
        if (values.image) {
            dataForm.append('InternshipProgramAboutImage', values.image)
        } else {
            dataForm.append('InternshipProgramAboutImage', values.icon)
        }
       
        try {
            const response = await axios.patch(`${process.env.REACT_APP_URL}/admin/internship/about`, dataForm)
