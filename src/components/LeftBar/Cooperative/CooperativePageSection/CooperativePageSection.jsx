...
const CooperativePageSection = () => {
    ...
    const fetchData = () => {
        ...
        axios.get((`${process.env.REACT_APP_URL}/admin/corporative/sections`))
            .then(res => {
                ...
                initialValuesRaw.CorporativePageSectionsImage = res.data[0]?.images[0]?.url;
    ...
    const onSubmitHandler = async (values) => {
        ...
        if (values.image) {
            dataForm.append('CorporativePageSectionsImage', values.image)
        } else {
            dataForm.append('CorporativePageSectionsImage', values.CorporativePageSectionsImage)
        }
    
        try {
            const response = await axios.patch(`${process.env.REACT_APP_URL}/admin/corporative/sections`, dataForm)
...
export default  CooperativePageSection