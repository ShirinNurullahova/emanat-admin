...
const  CooperativePageHeader = () => {
    ...
    const fetchData = () => {
        ...
        axios.get((`${process.env.REACT_APP_URL}/admin/corporative/header`))
            .then(res => {
                ...
                initialValuesRaw.CorporativePageHeaderImage = res.data[0]?.images[0]?.url;
    ...
    const onSubmitHandler = async (values) => {
        ...
        if (values.image) {
            dataForm.append('CorporativePageHeaderImage', values.image)
        } else {
            dataForm.append('CorporativePageHeaderImage', values.CorporativePageHeaderImage)
        }
      
        try {
            const response = await axios.patch(`${process.env.REACT_APP_URL}/admin/corporative/header`, dataForm)
...
export default  CooperativePageHeader