...
const Social = () => {
    ...
    const fetchData = () => {
        axios.get((`${process.env.REACT_APP_URL}/admin/main/cooperativeResponsibility`))
            .then(res => {
                ...
                initialValuesRaw.MainPageCooperativeImage = res.data[0]?.images[0]?.url;
    ...
    const onSubmitHandler = async (values) => {
        ...
        if (values.images) {
            dataForm.append('MainPageCooperativeImage', values.images)
        } else {
            dataForm.append('MainPageCooperativeImage', values.MainPageCooperativeImage)
        }
    
        try {
            const response = await axios.patch(`${process.env.REACT_APP_URL}/admin/main/cooperativeResponsibility`, dataForm)
